...
class WorkflowProcessor:
    ...
    def process_email(self, email_data: Dict[str, Any], explicit_order_id: Optional[int] = None) -> Dict[str, Any]:
    ...
    def _handle_clarification(self, customer_email: str, email_data: Dict, classification: Dict, explicit_order_id: Optional[int] = None) -> List[int]:
